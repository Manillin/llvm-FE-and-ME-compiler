...
// associa un tipo C++ ai token: tk type, tk name, tk value 
...
// ! REGOLE DI PARSING: regole grammaticali del linguaggio !
// specifica cosa fare quando viene riconosciuta una sequenza del linguaggio

// $$        -> rappresenta il valore dell'intera produzione
// $1,$2,... -> non terminali e terminali
...
// associatività sinistra: highestPriorityLast
%left ":" "?";
%left "<" ">" "==";
%left "+" "-";
%left "not";
