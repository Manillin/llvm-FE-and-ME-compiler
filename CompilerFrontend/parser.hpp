...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // stmts
      char dummy16[sizeof (std::vector<StmtAST*>)];
    ...
    TOK_OR = 279,                  // "or"
    TOK_NOT = 280,                 // "not"
    TOK_EXTERN = 281,              // "extern"
    TOK_DEF = 282,                 // "def"
    TOK_VAR = 283,                 // "var"
    TOK_GLOBAL = 284,              // "global"
    TOK_IF = 285,                  // "if"
    TOK_ELSE = 286,                // "else"
    TOK_FOR = 287,                 // "for"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_top = 39,                              // top
        S_definition = 40,                       // definition
        S_external = 41,                         // external
        S_proto = 42,                            // proto
        S_globalvar = 43,                        // globalvar
        S_idseq = 44,                            // idseq
        S_stmts = 45,                            // stmts
        S_stmt = 46,                             // stmt
        ...
        S_expif = 53,                            // expif
        S_ifstmt = 54,                           // ifstmt
        S_forstmt = 55,                          // forstmt
        S_init = 56,                             // init
        S_condexp = 57,                          // condexp
        S_relexp = 58,                           // relexp
        S_idexp = 59,                            // idexp
        S_optexp = 60,                           // optexp
        S_explist = 61                           // explist
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_forstmt: // forstmt
        value.move< ForStmtAST* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_ifstmt: // ifstmt
        value.move< IfStmtAST* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_stmt: // stmt
        value.move< StmtAST* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_stmts: // stmts
        value.move< std::vector<StmtAST*> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ForStmtAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ForStmtAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, IfStmtAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const IfStmtAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, StmtAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const StmtAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<StmtAST*>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<StmtAST*>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_forstmt: // forstmt
        value.template destroy< ForStmtAST* > ();
        break;
      ...
      case symbol_kind::S_ifstmt: // ifstmt
        value.template destroy< IfStmtAST* > ();
        break;
      ...
      case symbol_kind::S_stmt: // stmt
        value.template destroy< StmtAST* > ();
        break;
      ...
      case symbol_kind::S_stmts: // stmts
        value.template destroy< std::vector<StmtAST*> > ();
        break;
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_LSQRBR (location_type l)
      {
        return symbol_type (token::TOK_LSQRBR, std::move (l));
      }
#else
      static
      symbol_type
      make_LSQRBR (const location_type& l)
      {
        return symbol_type (token::TOK_LSQRBR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RSQRBR (location_type l)
      {
        return symbol_type (token::TOK_RSQRBR, std::move (l));
      }
#else
      static
      symbol_type
      make_RSQRBR (const location_type& l)
      {
        return symbol_type (token::TOK_RSQRBR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_forstmt: // forstmt
        value.copy< ForStmtAST* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_ifstmt: // ifstmt
        value.copy< IfStmtAST* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_stmt: // stmt
        value.copy< StmtAST* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_stmts: // stmts
        value.copy< std::vector<StmtAST*> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_forstmt: // forstmt
        value.move< ForStmtAST* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_ifstmt: // ifstmt
        value.move< IfStmtAST* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_stmt: // stmt
        value.move< StmtAST* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_stmts: // stmts
        value.move< std::vector<StmtAST*> > (YY_MOVE (s.value));
        break;
