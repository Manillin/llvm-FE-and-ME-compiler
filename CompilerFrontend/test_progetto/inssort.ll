...
cond4:                                            ; preds = %mergeblock, %init3
  ...
  br i1 %lttest9, label %loop5, label %endloop6
...
loop5:                                            ; preds = %cond4
  ...
  br i1 %lttest13, label %trueblock, label %falseblock

endloop6:                                         ; preds = %cond4
  %7 = phi double [ 0.000000e+00, %cond4 ]
  %step23 = load double, ptr %step, align 8
  %eqtest = fcmp ueq double %step23, 1.000000e+00
  br i1 %eqtest, label %trueblock24, label %falseblock26
