...
/*******************************************************************\
 * Enumerazione di tipo
 * Serve per distinguere il tipo di operazione che si sta facendo
 * Retrievable by: InitAST::getType()
 ********************************************************************/
enum initType
{
  ASSIGNMENT,
 ...
 * Permette di trattare i nodi di tipo Stmt in modo specifico.
 * Utile in futuro per espansioni o specializzazioni
 *********************************************************************/
...
/*********************************************************************\
 * Classe che rappresenta le inizializzazioni
 ********************************************************************/
 ...
 * Aggiunto possibilità di stmts plurali
 ********************************************************************/
...
public:
  // sovracarico del costruttore per permettere la creazione di un blocco con o senza definizioni
...
/// VarBindingsAST
//* Faccio ereditare da InitAST per poter trattare le inizializzazioni in modo specifico
...
public:
  ...
  initType getType() override; //******ADDED******/
...
/********************************************************************
* AssigmentExprAST -> prima grammatica
* Classe che rappresenta l'assegnamento di un valore a una variabile
/********************************************************************/
...
/********************************************************************
* variabile globale -> prima grammatica
* Classe che rappresenta la dichiarazione di una variabile globale
* Aggiunta la logica e possibilità di dichiarare un array
/********************************************************************/
